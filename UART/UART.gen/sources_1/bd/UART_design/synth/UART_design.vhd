...
--Date        : Tue May 10 12:27:35 2022
--Host        : DESKTOP-RN51NCC running 64-bit major release  (build 9200)
--Command     : generate_target UART_design.bd
--Design      : UART_design
...
entity UART_design is
  ...
  attribute CORE_GENERATION_INFO of UART_design : entity is "UART_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=UART_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of UART_design : entity is "UART_design.hwdef";
end UART_design;

architecture STRUCTURE of UART_design is
  component UART_design_processing_system7_0_0 is
  port (
  ...
  end component UART_design_processing_system7_0_0;
...
begin
processing_system7_0: component UART_design_processing_system7_0_0
     port map (
