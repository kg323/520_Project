...
HD_PWD='C:/ECE520/Project/UART/UART.runs/UART_design_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_design_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_design_processing_system7_0_0.tcl
