...
HD_PWD='C:/ECE520/Project/UART/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_design_wrapper.tcl -notrace
