...
HD_PWD='C:/ECE520/Project/UART/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_design_wrapper.tcl
